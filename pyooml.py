...
class Futaba3003(part):
    ...
    shaft_base_pos = np.array([body_size[0]/2. - shaft_d - shaft_diam/2.,
                                0,
                                body_size[2]/2.])
        
    #-- For building the servo what is really used is the
    #-- distance from the servo center
    ear_hi_center = ear_hi - body_size[2]/2.
    ...
    def _expr(self):
        ...
        base_shaft = cylinder(r=self.shaft_base_diam/2., h=self.shaft_base_hi, res=50)
...
#------------------------ Given by the user -----------
    ...
    def _expr(self):
        ...
        return servo.color(np.array([0, 0, 1])*0.8)
